...
Command: npx gltfjsx@6.5.3 computer_and_laptop.glb -T 
Files: computer_and_laptop.glb [4.24MB] > C:\Users\bruno\OneDrive\Máy tính\For fun (pratice actually)\3D-profolio\public\models\computer_and_laptop-transformed.glb [455.24KB] (89%)
...
export function Computer(props) {
  const { nodes, materials } = useGLTF(
    "/models/computer_and_laptop-transformed.glb"
  );
  return (
